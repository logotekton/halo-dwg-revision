...
`spikes/mlightcad/scripts/render-real.mjs`가 68장을 각각 새 헤드리스 Chromium에서 `AcApDocManager.openDocument()`로 열고 6초 대기 후 결과를 기록했다(SwiftShader 소프트웨어 GL, 1600×1100). `부하`는 최상위 엔티티 + 블록 정의 안 엔티티다 — INSERT가 렌더 시 전개되기 때문에 이쪽이 실제 지오메트리 양에 가깝다.

렌더 성공 60/68, 실패 8건(전부 렌더러 프로세스 crash).

| id | 파일 | MB | 최상위 | 블록내 | 부하 | 결과 | 렌더 s |
|---|---|---:|---:|---:|---:|---|---:|
| S042 | 김화공업고등학교 모듈러 생활관 제작·설치 구매_전기도서 (1).dwg | 19.83 | 348,076 | 125,080 | 473,156 | crash: page.evaluate: Target crashed  | — |
| S043 | 김화공업고등학교 모듈러 생활관 제작·설치 구매_통신도서.dwg | 8.86 | 70,550 | 118,260 | 188,810 | crash: page.evaluate: Target crashed  | — |
| S045 | 02_기계소방내진도면(김화공고 모듈러 생활관 증축공사).dwg | 9.80 | 89,621 | 93,340 | 182,961 | crash: page.evaluate: Target crashed  | — |
| S041 | 01_기계도면(김화공고 모듈러 생활관 증축공사)_수정.DWG | 7.68 | 127,974 | 43,971 | 171,945 | crash: page.evaluate: Target crashed  | — |
| S046 | 김화공업고등학교 모듈러 생활관 제작·설치 구매_전기소방도서 (3).dwg | 6.86 | 124,487 | 17,067 | 141,554 | crash: page.evaluate: Target crashed  | — |
| S044 | 01_기계소방도면(김화공고 모듈러 생활관 증축공사).dwg | 3.44 | 48,473 | 34,099 | 82,572 | crash: page.evaluate: Target crashed  | — |
| S055 | 250813-모듈안내도.dwg | 2.90 | 456 | 63,980 | 64,436 | crash: page.evaluate: Target crashed  | — |
| S059 | PLAN.dwg | 2.99 | 1,733 | 59,828 | 61,561 | ok | 8.6 |
| S063 | xr_section.dwg | 2.13 | 1,302 | 47,280 | 48,582 | ok | 7.8 |
| S054 | 250711-목업골조제작도.dwg | 1.84 | 7,390 | 37,674 | 45,064 | crash: page.evaluate: Target crashed  | — |
| S047 | PLAN.dwg | 1.96 | 1,656 | 33,528 | 35,184 | ok | 8.3 |
| S038 | A-810 천장 평면도.dwg | 1.65 | 1,028 | 30,969 | 31,997 | ok | 8.9 |
| S058 | PLAN(250618).dwg | 1.54 | 1,339 | 28,755 | 30,094 | ok | 7.9 |
| S001 | #기초 오시공 구조검토.dwg | 1.36 | 4,205 | 17,671 | 21,876 | ok | 7.4 |

성공한 도면의 최대 부하 61,561, crash한 도면의 최소 부하 45,064. 즉 이 구성의 뷰어 상한은 대략 **5만 렌더 엔티티**이고, ADR-0002 개정 §5의 A 티어 경계 25만과 5배 차이가 난다.
